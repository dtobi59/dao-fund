...
const Footer: FC<Props> = ({ classNameName}) => {

  return (
   
<footer className="px-3 py-8 bg-gray-100 dark:bg-gray-800 text-2 text-gray-500 dark:text-gray-200 transition-colors duration-200">
